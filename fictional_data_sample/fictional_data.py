...
QUERY = """ SELECT ?name ?nameLabel ?pic ?givenName ?givenNameLabel ?familyName ?familyNameLabel
...
WHERE
{
    ...
    #?name wdt:P5800 wd:Q215972. # Protagonista narrative role
...
def main():
    ...
    #select the headers
    headers = ["name", "gender", "givenName", "familyName", "occupation", "citizenship", \
               "placeOfBirth", "dateOfBirth", "placeOfDeath", "dateOfDeath", "causeOfDeath"]
    new_headers = []
    ...
    data_frame.to_csv("output/fictional_data.csv")
